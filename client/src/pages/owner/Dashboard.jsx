...
    { title: "Pending Bookings", value: data.pendingBookings || 0, icon: assets.cautionIconColored },
    { title: "Completed Bookings", value: data.completedBookings || 0, icon: assets.tick_icon },
  ];
...
                    {new Intl.NumberFormat("en-US", { style: "currency", currency }).format(booking.price || 0)}
                  </p>
...
            {new Intl.NumberFormat("en-US", { style: "currency", currency }).format(data.monthlyRevenue || 0)}
          </p>
        </div>
      </div>
    </div>
