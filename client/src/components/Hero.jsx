...
const handleSearch = (e) => {
  ...
  const pickupDateParam = PickupDate || 'defaultPickupDate';
  const returnDateParam = returnDate || 'defaultReturnDate';

  navigate(`/cars?pickupLocation=${PickupLocation}&pickupDate=${pickupDateParam}&returnDate=${returnDateParam}`);
};
